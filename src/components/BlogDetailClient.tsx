...
function ShareButtons({ url, title }: ShareButtonsProps) {
  ...
  return (
    <div className="flex items-center space-x-4">
      <span className="text-gray-300 font-semibold">Compartir:</span>
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white p-3 rounded-lg transition-all duration-300"
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="bg-black hover:bg-gray-800 text-white p-3 rounded-lg transition-colors duration-300"
...
function SafeDate({ dateString }: { dateString: string }) {
  ...
  if (!mounted) {
    return <span>Cargando fecha...</span>;
  }
...
export default function BlogDetailClient({ post }: BlogDetailClientProps) {
  const currentUrl = `https://bsg-pay.vercel.app/blog/${post.id}`;
  ...
  return (
    <div className="min-h-screen bg-black py-20">
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Call to Action */}
        <div className="bg-gradient-to-r from-gray-900/50 to-gray-800/50 backdrop-blur-sm rounded-3xl p-8 border border-gray-700 text-center">
          <h3 className="text-2xl font-bold text-white mb-4">
            ¿Listo para verificar tu cuenta PayPal?
          </h3>
          <p className="text-gray-300 mb-6">
            Después de conocer todos los beneficios, ¡da el siguiente paso con
            BSG Pay!
          </p>
          <a
            href="https://wa.me/573104430801?text=¡Hola! 👋 Vengo desde su blog y estoy interesado en verificar mi cuenta PayPal. ¿Podrían ayudarme con el proceso?"
            target="_blank"
            rel="noopener noreferrer"
